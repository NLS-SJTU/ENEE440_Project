...
.macro DirectWrite PortFooAddr reg1 reg2 @; data in reg1
	ldr \reg2, =\PortFooAddr
	str \reg1,[\reg2]
...
1:	@; word access:
	DirectWrite \PortAddr \SetVal_r \temp_r1
.endm
...
.macro SetVal_4bits_2wl PortAddr_H PortAddr_L ShiftVal_r SetVal_r temp_r1 temp_r2 temp_r3 	
	...
	lsl \SetVal_r, \SetVal_r, \ShiftVal_r
	orr \SetVal_r, \temp_r1, \SetVal_r
	DirectWrite \PortAddr_L \SetVal_r \temp_r1
	b 4f
3:	@; access high word
	...
	lsl \SetVal_r, \SetVal_r, \ShiftVal_r
	orr \SetVal_r, \temp_r1, \SetVal_r
	DirectWrite \PortAddr_H \SetVal_r \temp_r1
	b 4f
1:	@; word access:
	cmp \ShiftVal_r, #16
	beq 2f
