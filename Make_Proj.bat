...
REM linking
arm-none-eabi-gcc -nostartfiles -g -Wl,--no-gc-sections -Wl,-Map,Blinky.map -Wl,-T .\sources\linkBlinkySTM32F4_01.ld -o Blinky.elf aStartup.o system_stm32f4xx.o cLED.o cMain.o -lgcc
